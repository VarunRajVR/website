...
export const Banner = () => {
  ...
  const toRotate = [ "Web Developer", "Cloud Devops Engineer", "AI/ML Engineer" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Varun`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Cloud Devops Engineer", "AI/ML Engineer" ]'><span className="wrap">{text}</span></span></h1>
                  <p>
